...
# Sol sütunda siyah yazı
    ...
    st.markdown('<p class="inline-text black-text">Son Güncellenme Tarihi:28 Mart 2024</p>', unsafe_allow_html=True)
    st.markdown('<p class="inline-text black-text">Sonraki Güncellenme Tarihi:3 Nisan 2024</p>', unsafe_allow_html=True)
...
if page=='Model Bazlı Aylık Tahmin':
    ...
    selected_model = st.sidebar.selectbox("Tarih", ["Mart 2024"])
