...
go.Scatter(x=yıllıktahmin["Ortalama"].iloc[1:22].index,y=yıllıktahmin["Ortalama"].iloc[1:22],mode='lines',name="Enflasyon"),
...
if page=='Aylık Enflasyon':
    ...
    st.image("https://resmim.net/cdn/2024/05/23/fu9kAi.png")
