...
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[20:25],y=[61.94,60.84,62.18,64.70,65.06],mode='markers',name="Geçmiş Tahminler",line_color="black"))
...
go.Scatter(x=yıllıktahmin["Gaussian Regression"].iloc[23:-2].index,y=yıllıktahmin["Gaussian Regression"].iloc[23:],mode='lines',name="Gaussian Regression",line={'dash':'dash'}),
...
# Sol sütunda siyah yazı
    ...
    '<p class="inline-text red-text">%3.54(Önceki %3.47)</p>'
    '</div>',
    unsafe_allow_html=True
)
    st.markdown('<p class="inline-text black-text">Son Güncellenme Tarihi:16 Şubat 2024</p>', unsafe_allow_html=True)
    st.markdown('<p class="inline-text black-text">Sonraki Güncellenme Tarihi:22 Şubat 2024</p>', unsafe_allow_html=True)
...
if page=='Model Bazlı Aylık Tahmin':
    ...
    selected_model = st.sidebar.selectbox("Tarih", ["Şubat 2024","Mart 2024","Nisan 2024","Mayıs 2024","Haziran 2024","Temmuz 2024","Ağustos 2024","Eylül 2024","Ekim 2024","Kasım 2024","Aralık 2024"])
