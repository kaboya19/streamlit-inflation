...
# Sol sütunda siyah yazı
    ...
    st.markdown('<p class="inline-text black-text">Son Güncellenme Tarihi:28 Nisan 2024</p>', unsafe_allow_html=True)
    st.markdown('<p class="inline-text black-text">Sonraki Güncellenme Tarihi:3 Mayıs 2024</p>', unsafe_allow_html=True)
