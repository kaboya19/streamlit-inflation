...
# Sol sütunda siyah yazı
    ...
    '<p class="inline-text red-text">%3.70(Önceki %3.54)</p>'
    '</div>',
    unsafe_allow_html=True
)
    st.markdown('<p class="inline-text black-text">Son Güncellenme Tarihi:29 Şubat 2024</p>', unsafe_allow_html=True)
    st.markdown('<p class="inline-text black-text">Sonraki Güncellenme Tarihi:4 Mart 2024</p>', unsafe_allow_html=True)
