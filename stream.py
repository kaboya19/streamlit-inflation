...
go.Scatter(x=yıllıktahmin["Ortalama"].loc["2024-06-30":"2024-12-31"].index,y=yıllıktahmin["Ortalama"].loc["2024-06-30":"2024-12-31"],mode='lines',name="Ortalama",line={'dash':'dash'}),
go.Scatter(x=yıllıktahmin["p1"].loc["2024-06-30":"2024-12-31"].index,y=yıllıktahmin["p1"].loc["2024-06-30":"2024-12-31"],mode='lines',name="Prophet 1",line={'dash':'dash'}),
go.Scatter(x=yıllıktahmin["p2"].loc["2024-06-30":"2024-12-31"].index,y=yıllıktahmin["p2"].loc["2024-06-30":"2024-12-31"],mode='lines',name="Prophet 2",line={'dash':'dash'}),
go.Scatter(x=yıllıktahmin["p3"].loc["2024-06-30":"2024-12-31"].index,y=yıllıktahmin["p3"].loc["2024-06-30":"2024-12-31"],mode='lines',name="Prophet 3",line={'dash':'dash'}),
go.Scatter(x=yıllıktahmin["p4"].loc["2024-06-30":"2024-12-31"].index,y=yıllıktahmin["p4"].loc["2024-06-30":"2024-12-31"],mode='lines',name="Prophet 4",line={'dash':'dash'}),
go.Scatter(x=yıllıktahmin["p5"].loc["2024-06-30":"2024-12-31"].index,y=yıllıktahmin["p5"].loc["2024-06-30":"2024-12-31"],mode='lines',name="Prophet 5",line={'dash':'dash'})
])
...
# Sol sütunda siyah yazı
    ...
    '<p class="inline-text black-text" style="margin-right: 1px;">Temmuz Ayı Enflasyon Tahmini:</p>'
    '<p class="inline-text red-text">%3.21(Önceki %3.28)</p>'
    '</div>',
    unsafe_allow_html=True
)
    st.markdown('<p class="inline-text black-text">Son Güncellenme Tarihi:25 Temmuz 2024</p>', unsafe_allow_html=True)
    st.markdown('<p class="inline-text black-text">Sonraki Güncellenme Tarihi:1 Ağustos 2024</p>', unsafe_allow_html=True)
...
if page=='Aylık Enflasyon':
    ...
    st.image("https://resmim.net/cdn/2024/07/22/W8r9k2.png")
