...
if page=='Yıllık Enflasyon':
    ...
    st.write("<h1 style='text-align:left;'>Ocak Ayı Enflasyon Tahmini:%6.69(Önceki %6.47)(</h1>",unsafe_allow_html=True)
    st.write("<h1 style='text-align:left;'>Güncelleme Tarihi:22 Ocak 2024(</h1>",unsafe_allow_html=True)
    st.write("<h1 style='text-align:left;'>Sonraki Güncelleme Tarihi:25 Ocak 2024(</h1>",unsafe_allow_html=True)
